...
(function () {
  ...
  const dict = {
    en: {
      ...
      'footer.about.desc': 'A stylish Blackjack web app created for practicing casino game rules and strategies. Developed for a school cultural festival casino experience.',
      'footer.ai.title': 'AI-Powered Development',
      'footer.ai.desc': 'This project was primarily developed by AI. Opal designed the game structure, initial design, and created the foundation. GitHub Copilot enhanced, refined, and extended the functionality.',
    ...
    ja: {
      ...
      'footer.about.desc': '学校の文化祭でクラスがカジノをテーマにした際、ブラックジャックのルールや戦略をスマートフォンから手軽に練習できるように開発したWebアプリです。',
      'footer.ai.title': 'AI主導の開発',
      'footer.ai.desc': 'このプロジェクトは主にAIによって開発されました。Opalがゲーム設計、初期デザイン、基盤作成を担当し、GitHub Copilotが機能の強化、洗練、拡張を行いました。',
  ...
  function interpolate(str, params) {
    ...
    return str.replace(/\{(.*?)\}/g, (_, k) => (k in params ? String(params[k]) : ''));
  }
